...
let pp = './media/menus/catmenub.png'
...
let str = `
*ミ💖 𝙷𝙾𝙻𝙰 ✨${name}✨, 𝙰𝚀𝚄𝙸 𝙴𝚂𝚃𝙰 𝙴𝙻 𝙼𝙴𝙽𝚄 𝙲𝙾𝙼𝙿𝙻𝙴𝚃𝙾 𝙳𝙴 GATABOT - MIAUU 💖彡*
...
`.trim()
conn.sendHydrated(m.chat, str, wm, pp, '🤡 𝙃𝙊𝙇𝘼 Michu michu 🤡', `Hola`, null, null, [
